            ...
            <form action="https://formbold.com/s/unique_form_id" method="POST">
              <div className="relative w-96 max-w-md">
                ...
                <input
                  ...
                  className="w-full py-2 pl-10 pr-4 text-sm text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 shadow-none hover:border-gray-300"
                />
