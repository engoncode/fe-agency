      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-gray-200 dark:border-gray-900">
            ...
            <th className="py-3 px-4 text-left font-medium text-gray-500 dark:text-gray-400">Start Date</th>
            <th className="py-3 px-4 text-left font-medium text-gray-500 dark:text-gray-400">End Date</th>
            ...
            campaigns.map((campaign) => (
              <tr
                ...
                <td className="py-3 px-4 text-gray-700 dark:text-gray-300 capitalize">
                  {campaign.platform_deliverables?.[0]?.platform_name || "-"}{" "}
                ...
                <td className="py-3 px-4 text-gray-700 dark:text-gray-300">{formatDate(campaign.start_date)}</td>
                <td className="py-3 px-4 text-gray-700 dark:text-gray-300">{formatDate(campaign.end_date)}</td>
